...
Postgre의 도입 이후SQL 10.0, 여기에 설명된 모든 조인 옵션은 병렬 버전에서도 사용할 수 있습니다. 따라서 mai 최적기는 이러한 표준 조인 옵션만 고려하는 것이 아니라 병렬 쿼리를 수행하는 것이 타당한지 여부를 평가합니다.
...
차이점을 완전히 인식하지 못하는 많은 개발자는
UNION 절과 UNION ALL 절이 나쁜 것에 대해 불평합니다.
TIP 성능은 PostgreSQL이 중복을 필터링해야 한다는 사실을 인식하지 못하기 때문에 큰 데이터 세트의 경우 특히 고통스럽습니다.
